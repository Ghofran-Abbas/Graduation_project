...
class ArchiveSectionTrainerViewBody extends StatelessWidget {
  const ArchiveSectionTrainerViewBody({super.key, required this.sectionId});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: CustomScreenBody(
        title: 'Archive trainer Video Editing',
                ...
                Column(
                  children: [
                    CustomCourseInformation(
                      ...
                      onTap: (){},
                      onTapDate: (){
                        context.go('${GoRouterPath.trainerDetails}/1${GoRouterPath.trainerArchiveCourseView}/1${GoRouterPath.archiveSectionTrainerView}/1${GoRouterPath.completeCalendar}/1');
                      },
                      onTapFirstIcon: (){},
                      onTapSecondIcon: (){},
                    ),
                                    ...
                                    CustomOverloadingAvatar(
                                      ...
                                      onTap: () {
                                        if(stateSS.students.students.data![0].students!.isNotEmpty) {
                                          context.go('${GoRouterPath.trainerDetails}/${stateSS.students.students.data![0].students![0].id}${GoRouterPath.trainerArchiveCourseView}/${stateSS.students.students.data![0].students![0].id}${GoRouterPath.archiveSectionTrainerView}/${stateSS.students.students.data![0].id}${GoRouterPath.completeStudents}/${stateSS.students.students.data![0].id}');
                                        }
                                      },
                                    ),
                                    SizedBox(
                                  ...
                                  child: CustomOverloadingAvatar(
                                    ...
                                    onTap: () {
                                      if(stateTS.trainers.trainers![0].trainers!.isNotEmpty) {
                                        context.go('${GoRouterPath.trainerDetails}/${stateTS.trainers.trainers![0].trainers![0].id}${GoRouterPath.trainerArchiveCourseView}/${stateTS.trainers.trainers![0].trainers![0].id}${GoRouterPath.archiveSectionTrainerView}/${stateTS.trainers.trainers![0].id}${GoRouterPath.completeTrainers}/${stateTS.trainers.trainers![0].id}');
                                      } /*else {
