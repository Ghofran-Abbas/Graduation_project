...
import '../../../../course/presentation/manager/trainer_rating_cubit/trainer_rating_state.dart';
...
class DetailsCompleteTrainerViewBody extends StatelessWidget {
  const DetailsCompleteTrainerViewBody({super.key, required this.sectionId});
                            ...
                            child: Column(
                              ...
                              children: [
                                CustomProfileInformation(
                                  ...
                                  onTapGifts: () {},
                                  onTapRating: () {
                                    context.go('${GoRouterPath.completeDetails}/$sectionId${GoRouterPath.completeTrainers}/$sectionId${GoRouterPath.detailsCompleteTrainer}/$sectionId/${state.showResult.trainer.id}${GoRouterPath.trainerRating}/${state.showResult.trainer.id}/$sectionId');
                                  },
                                  onTap: () {},
                                ),
                                Padding(
