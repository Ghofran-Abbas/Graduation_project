...
import '../../manager/confirm_reservation_student_cubit/confirm_reservation_student_state.dart';
...
import '../../manager/delete_section_student_cubit/delete_section_student_state.dart';
                      ...
                      if (stateRS is ReservationStudentsSectionSuccess) {
                        return Padding(
                          ...
                          child: CustomScreenBody(
                            title: 'Students',
                            textSecondButton: AppLocalizations
                                .of(context)
                                                                            ...
                                                                            children: [
                                                                              TextIconButton(
                                                                                ...
                                                                                onPressed: () {
                                                                                  context
                                                                                      .read<
                                                                                      DeleteSectionStudentCubit>()
                                                                                      .fetchDeleteSectionStudent(
                                                                                      sectionId: stateCS
                                                                                          .confirmedStudents
                                                                                          .students
                                                                                          .data![0]
