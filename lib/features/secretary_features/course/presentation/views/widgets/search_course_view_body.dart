...
import 'package:alhadara_dashboard/features/secretary_features/course/presentation/manager/search_course_cubit/search_course_state.dart';
...
class SearchCourseViewBody extends StatelessWidget {
  SearchCourseViewBody({super.key});
                    ...
                    state.course.courses.data!.isNotEmpty ? GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Align(child: CustomCard(
                          ...
                          showIcons: true,
                          onTap: () {
                            context.go('${GoRouterPath.courses}/${state.course.courses.data![index].departmentId}${GoRouterPath.courseDetails}/${state.course.courses.data![index].id}');
                          },
                          onTapFirstIcon: (){},
                          onTapSecondIcon: () {},
                        ));
